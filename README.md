...
- Move Forecast may preview selected-move risk, signal, and next zone state before commitment, but it must remain diegetic consequence material and never become a flat reward bar, tutorial overlay, or generic action-menu effect.
